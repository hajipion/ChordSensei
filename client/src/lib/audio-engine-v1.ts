...
// V1.0 Audio Engine - Basic Salamander Grand Piano Sampler
export class AudioEngineV1 {
...
// V1.0 Global audio engine instance
export const audioEngineV1 = new AudioEngineV1();